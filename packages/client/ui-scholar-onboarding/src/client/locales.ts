...
export const en = {
  ...
  rejected: 'Proxy Hub rejected the current Scholar Token (HTTP 401). The stored credential was kept; paste a replacement Token issued by your administrator to reconnect.',
...
export const zh: { [Key in ScholarOnboardingKey]: string } = {
  ...
  rejected: 'Proxy Hub 拒绝了当前 Scholar Token（HTTP 401）。已保存的凭据未被删除；请粘贴管理员新签发的 Token 以恢复连接。',
